...
public class Fragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.semua_tampil_1);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        recyclerView.setAdapter(new Fragment1.MyAdapter());

        return view;
    }
    private class MyAdapter extends RecyclerView.Adapter<Fragment1.MyAdapter.MyViewHolder> {

        @NonNull
        @Override
        public Fragment1.MyAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.list_item_tampil_surat, parent, false);
            return new Fragment1.MyAdapter.MyViewHolder(itemView);
        }

        @Override
        public void onBindViewHolder(@NonNull Fragment1.MyAdapter.MyViewHolder holder, int position) {
