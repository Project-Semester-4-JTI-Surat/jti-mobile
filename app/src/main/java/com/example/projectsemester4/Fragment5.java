...
public class Fragment5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.semua_tampil_5);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        recyclerView.setAdapter(new Fragment5.MyAdapter());

        return view;
    }
    private class MyAdapter extends RecyclerView.Adapter<Fragment5.MyAdapter.MyViewHolder> {

        @NonNull
        @Override
        public Fragment5.MyAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.list_item_tampil_surat, parent, false);
            return new Fragment5.MyAdapter.MyViewHolder(itemView);
        }

        @Override
        public void onBindViewHolder(@NonNull Fragment5.MyAdapter.MyViewHolder holder, int position) {
